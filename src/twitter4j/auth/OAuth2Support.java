 ...
 * @see <a href=
 *      "https://dev.twitter.com/docs/auth/application-only-auth">Application-only
 *      authentication | Twitter Developers</a>
 */
public interface OAuth2Support {
	 ...
	 *                               or connecting non-SSL endpoints.
	 * @throws IllegalStateException when Bearer token is already available, or
	 *                               OAuth consumer is not available.
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/post/oauth2/token">POST
	 *      oauth2/token | Twitter Developers</a>
	 */
