...
/* package */ class RelationshipJSONImpl extends TwitterResponseImpl implements Relationship, java.io.Serializable {
	...
	public boolean equals(Object o) {
		...
		if (sourceBlockingTarget != that.sourceBlockingTarget)
			return false;
		if (sourceCanDm != that.sourceCanDm)
			return false;
		if (sourceFollowedByTarget != that.sourceFollowedByTarget)
			return false;
		if (sourceFollowingTarget != that.sourceFollowingTarget)
			return false;
		if (sourceMutingTarget != that.sourceMutingTarget)
			return false;
		if (sourceNotificationsEnabled != that.sourceNotificationsEnabled)
			return false;
		if (sourceUserId != that.sourceUserId)
			return false;
		if (targetUserId != that.targetUserId)
			return false;
		if (wantRetweets != that.wantRetweets)
			return false;
		if (sourceUserScreenName != null ? !sourceUserScreenName.equals(that.sourceUserScreenName)
				: that.sourceUserScreenName != null)
			return false;
		if (targetUserScreenName != null ? !targetUserScreenName.equals(that.targetUserScreenName)
				: that.targetUserScreenName != null)
			return false;
	...
	public String toString() {
		return "RelationshipJSONImpl{" + "targetUserId=" + targetUserId + ", targetUserScreenName='"
				+ targetUserScreenName + '\'' + ", sourceBlockingTarget=" + sourceBlockingTarget
				+ ", sourceNotificationsEnabled=" + sourceNotificationsEnabled + ", sourceFollowingTarget="
				+ sourceFollowingTarget + ", sourceFollowedByTarget=" + sourceFollowedByTarget + ", sourceCanDm="
				+ sourceCanDm + ", sourceMutingTarget=" + sourceMutingTarget + ", sourceUserId=" + sourceUserId
				+ ", sourceUserScreenName='" + sourceUserScreenName + '\'' + ", wantRetweets=" + wantRetweets + '}';
	}
}