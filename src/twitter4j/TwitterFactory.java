...
public final class TwitterFactory implements java.io.Serializable {
	...
	static final Authorization DEFAULT_AUTHORIZATION = AuthorizationFactory
			.getInstance(ConfigurationContext.getInstance());
	 ...
	 * consumer key and consumer Secret must be provided by twitter4j.properties, or
	 * system properties.<br>
	 * Unlike {@link Twitter#setOAuthAccessToken(twitter4j.auth.AccessToken)}, this
	 * factory method potentially returns a cached instance.
	 *
