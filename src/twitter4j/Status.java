...
public interface Status extends Comparable<Status>, TwitterResponse, EntitySupport, java.io.Serializable {
	 ...
	 *
	 * @return returns The location that this tweet refers to if available (can be
	 *         null)
	...
	/**
	 * Returns true if the authenticating user has retweeted this tweet, or false
	...
	/**
	 * Returns the authenticating user's retweet's id of this tweet, or -1L when the
	 * tweet was created before this feature was enabled.
	 *
	 ...
	 *
	 * @return list of country codes where the tweet is withheld - null if not
	 *         withheld
