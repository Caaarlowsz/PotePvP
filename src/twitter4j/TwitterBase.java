...
public interface TwitterBase {
	 ...
	 * This method may internally call verifyCredentials() on the first invocation
	 * if<br>
	 ...
	 * @throws IllegalStateException if no credentials are supplied. i.e.) this is
	 *                               an anonymous Twitter instance
	 ...
	 * The returned type will be either of BasicAuthorization, OAuthAuthorization,
	 * or NullAuthorization
	 *
