...
final class HTMLEntity {
	...
	static {
		String[][] entities = { { "&nbsp;", "&#160;"/* no-break space = non-breaking space */, "\u00A0" },
				{ "&iexcl;", "&#161;"/* inverted exclamation mark */, "\u00A1" },
				{ "&cent;", "&#162;"/* cent sign */, "\u00A2" }, { "&pound;", "&#163;"/* pound sign */, "\u00A3" },
				...
				/*
				 * Unicode does not say that lArr is the same as the 'is implied by' arrow but
				 * also does not have any other character for that function. So ? lArr can be
				 * used for 'is implied by' as ISOtech suggests
				 */
				...
				{ "&sdot;", "&#8901;"/* dot operator */, "\u22C5" }
				/*
				 * dot operator is NOT the same character as ,"\u00B7"} /* Miscellaneous
				 * Technical
				 */
