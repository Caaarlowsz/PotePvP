...
public interface SuggestedUsersResources {
	 ...
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/users/suggestions/:slug">GET
	 ...
	 * user categories. The category can be used in the users/suggestions/category
	 * endpoint to get the users in that category. <br>
	 ...
	 *                                    unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/users/suggestions">GET
	 *      users/suggestions | Twitter Developers</a>
	 * @since Twitter4J 2.1.1
	 */
	 ...
	 * return their most recent status if they are not a protected user. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/users/suggestions/%3Aslug/members">GET
	 *      users/suggestions/:slug/members | Twitter Developers</a>
