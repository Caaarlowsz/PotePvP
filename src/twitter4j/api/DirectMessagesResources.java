...
public interface DirectMessagesResources {
	 ...
	 * This method calls https://api.twitter.com/1.1/direct_messages
	 *
	 * @return List
	 ...
	 * This method calls https://api.twitter.com/1.1/direct_messages/sent
	 *
	 * @return List
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/direct_messages/sent">GET
	 ...
	 * This method calls https://api.twitter.com/1.1/direct_messages/show/:id.json
	 *
	 * @param id message id
	 ...
	 * <br>
	 * This method calls https://api.twitter.com/1.1/direct_messages/destroy
	 *
	 * @param id the ID of the direct message to destroy
	 * @return the deleted direct message
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/direct_messages/destroy/:id">POST
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/direct_messages/new">POST
	 ...
	 * @return InputStream
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/discussions/24255">Access media shared
	 *      in direct messages | Twitter Developers</a>
