...
public interface UsersResources {
	/**
	 * Returns the current trend, geo, language, timezone and sleep time information
	 ...
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/account/settings">GET
	 ...
	 *                                    unavailable, or if supplied credential is
	 *                                    wrong (TwitterException.getStatusCode() ==
	 *                                    401)
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/account/verify_credentials">GET
	...
	/**
	 * Updates the current trend, geo, language, timezone and sleep time information
	 * for the authenticating user. <br>
	 * This method has not been finalized and the interface is subject to change in
	 * incompatible ways. <br>
	 * This method calls https://api.twitter.com/1.1/account/settings.json
	 *
	 * @param trendLocationWoeid Optional. The Yahoo! Where On Earth ID to use as
	 ...
	 * @param lang               Optional. The language which Twitter should render
	 *                           in for this user. (two letter ISO 639-1)
	 * @return the current trend, geo and sleep time information for the
	 *         authenticating user.
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/account/settings">POST
	 *      account/settings | Twitter Developers</a>
	 ...
	 * @param url         Optional. Maximum of 100 characters. Will be prepended
	 *                    with "http://" if not present.
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/account/update_profile">POST
	 ...
	 * @param tile  If set to true the background image will be displayed tiled. The
	 *              image will not be tiled otherwise.
	 * @return the updated user
	 ...
	 *                          specified file object in not representing a file
	 *                          (IOException will be nested)
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/account/update_profile_background_image">POST
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/account/update_profile_colors">POST
	 ...
	 *              kilobytes in size. Images with width larger than 500 pixels will
	 *              be scaled down.
	 * @return the updated user
	 * @throws TwitterException when Twitter service or network is unavailable, or
	 *                          when the specified file is not found
	 ...
	 *                          (IOException will be nested)
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/account/update_profile_image">POST
	 ...
	 * This method calls https://api.twitter.com/1.1/blocks/blocking.json
	 *
	 * @param cursor Causes the list of blocked users to be broken into pages of no
	 ...
	 * Returns the un-blocked user in the requested format when successful. <br>
	 * This method calls https://api.twitter.com/1.1/blocks/destroy/[id].json
	 *
	 * @param userId the ID of the user to block
	 * @return the unblocked user
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/post/blocks/destroy">POST
	...
	/**
	 * Returns a list of user objects that the authenticating user is muting. <br>
	 * This method calls https://api.twitter.com/1.1/mutes/users/list
	 *
	 * @param cursor Causes the list of muted users to be broken into pages of no
	 *               more than 5000 IDs at a time. The number of IDs returned is not
	 *               guaranteed to be 5000 as suspended users are filtered out after
	 *               connections are queried. If no cursor is provided, a value of
	 *               -1 will be assumed, which is the first "page."
	 * @return a list of user objects that the authenticating user
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/mutes/users/list">GET
	 *      blocks/blocking | Twitter Developers</a>
	...
	/**
	 * Returns an array of numeric user ids the authenticating user is muting. <br>
	 ...
	 *         muting.
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/mutes/users/ids">GET
	 *      blocks/ids | Twitter Developers</a>
	 * @since Twitter4J 4.0.2
	 */
	 ...
	 * Returns the muted user in the requested format when successful. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/mutes/users/create">POST
	 *      mutes/users/create | Twitter Developers</a>
	 * @since Twitter4J 4.0.2
	 */
	User createMute(long userId) throws TwitterException;

	/**
	 * Mutes the user specified in the screen name parameter as the authenticating
	 * user. Returns the muted user in the requested format when successful. <br>
	 * This method calls https://api.twitter.com/1.1/mutes/users/create
	 *
	 ...
	 * Returns the un-muted user in the requested format when successful. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/mutes/users/destroy">POST
	 *      mutes/users/destroy | Twitter Developers</a>
	 * @since Twitter4J 4.0.2
	 */
	User destroyMute(long userId) throws TwitterException;

	/**
	 * Un-mutes the user specified in the screen name parameter as the
	 * authenticating user. Returns the un-muted user in the requested format when
	 * successful. <br>
	 * This method calls https://api.twitter.com/1.1/mutes/users/destroy
	 *
	 * @param screenName the screen_name of the user to mute
	 ...
	 * the authenticating user has permission) will be returned inline. <br>
	 ...
	 * using this API.<br>
	 * Usage note: It is only possible to retrieve the first 1000 matches from this
	 * API. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/users/contributees">GET
	 *      users/contributors | Twitter Developers</a>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/users/contributors">GET
	 *      users/contributors | Twitter Developers</a>
	 * @since Twitter4J 3.0.0
	 */
	 ...
	 *
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/account/remove_profile_banner">POST
	 *      account/remove_profile_banner | Twitter Developers</a>
	 * @since Twitter4J 3.0.0
	 * @throws TwitterException when Twitter service or network is unavailable
	 */
	 ...
	 * <a href="https://dev.twitter.com/docs/platform-objects/users">Users</a>
	 * objects. More information about sizing variations can be found in
	 * <a href="https://dev.twitter.com/docs/user-profile-images-and-banners">User
	 * Profile Images and Banners</a>.<br>
	 * Profile banner images are processed asynchronously. The profile_banner_url
	 * and its variant sizes will not necessary be available directly after
	 * upload.<br>
	 * <br>
	 * This method calls
	 * https://api.twitter.com/1.1/account/update_profile_banner.json
	 *
	 * @param image For best results, upload an &lt;5MB image that is exactly 1252px
	 *              by 626px.
	 * @throws TwitterException when Twitter service or network is unavailable, or
	 *                          when the specified file is not found
	 *                          (FileNotFoundException will be nested), or when the
	 ...
	 *                          (IOException will be nested)
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/account/update_profile_banner">POST
	 *      account/update_profile_banner | Twitter Developers</a>
	 * @since Twitter4J 3.0.0
	 */
