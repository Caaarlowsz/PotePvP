...
public interface TweetsResources {
	 ...
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/statuses/retweets/:id">Tweets
	 ...
	 * retweeted the tweet specified by the id parameter. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/statuses/retweeters/ids">Tweets
	 *      Resources › statuses/retweeters/ids</a>
	 * @since Twitter4J 3.0.5
	 */
	IDs getRetweeterIds(long statusId, long cursor) throws TwitterException;

	/**
	 * Returns a collection of up to {@code count} user IDs belonging to users who
	 * have retweeted the tweet specified by the id parameter. <br>
	 * This method calls https://api.twitter.com/1.1/get/statuses/retweeters/ids
	 *
	 * @param statusId The numerical ID of the tweet you want the retweeters of.
	 ...
	 *                                    unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/statuses/show/:id">GET
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/statuses/destroy/:id">POST
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/post/statuses/update">POST
	 ...
	 * to the authenticating user's text identical to the authenticating user's
	 * current status will be ignored to prevent duplicates. <br>
	 * This method calls https://api.twitter.com/1.1/statuses/update or<br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/statuses/retweet/:id">POST
	 ...
	 * Tweet on third party sites. See the <a href="http://oembed.com/">oEmbed</a>
	 * specification for information about the response format. While this endpoint
	 * allows a bit of customization for the final appearance of the embedded Tweet,
	 * be aware that the appearance of the rendered Tweet may change over time to be
	 * consistent with Twitter's
	 * <a href="https://dev.twitter.com/terms/display-requirements">Display
	 * Requirements</a>. Do not rely on any class or id parameters to stay constant
	 * in the returned markup. <br>
	 * This method calls https://api.twitter.com/1.1/statuses/oembed.json
	 *
	 * @param req request
	 * @return information allowing the creation of an embedded representation of a
	 *         Tweet on third party sites
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/statuses/oembed">GET
	 ...
	 * specified by comma-separated values passed to the id parameter. This method
	 * is especially useful to get the details (hydrate) a collection of Tweet IDs.
	 * <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/statuses/lookup">GET
	 *      statuses/lookup</a>
	 ...
	 * {@link #updateStatus(twitter4j.StatusUpdate)} <br>
	 ...
	 *      statuses/update | Twitter Developers</a>
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/multiple-media-extended-entities">Multiple
	 *      Media Entities in Statuses</a>
	 * @since Twitter4J 4.0.2
	 */
