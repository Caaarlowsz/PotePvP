...
public interface ListsResources {
	 ...
	 * authenticated users is the same as the user whose lists are being returned.
	 * <br>
	 * This method calls https://api.twitter.com/1.1/lists.json
	 *
	 * @param listOwnerScreenName The screen name of the list owner as returned to
	 *                            in the response body's next_cursor and
	 *                            previous_cursor attributes to page back and forth
	 *                            in the list.
	 * @return the list of lists
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/lists/list">GET
	 *      lists/list | Twitter Developers</a>
	 ...
	 *                            previous_cursor attributes to page back and forth
	 *                            in the list.
	 * @param reverse             Set this to true if you would like owned lists to
	 *                            be returned first
	 * @return the list of lists
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/lists/list">GET
	 ...
	 * https://api.twitter.com/1/user/lists/list_id/statuses.json
	 *
	 * @param ownerId The user ID of the user who owns the list being requested by a
	 *                slug.
	 ...
	 *
	 * @param ownerScreenName The screen name of the user who owns the list being
	 *                        requested by a slug.
	 * @param slug            slug of the list
	 * @param paging          controls pagination. Supports since_id, max_id, count
	 *                        and page parameters.
	 * @return list of statuses for members of the specified list
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/lists/statuses">GET
	 ...
	 * the list's owner to remove members from the list. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/lists/members/destroy">POST
	...
	/**
	 * Removes the specified members from the list. The authenticated user must be
	 * the list's owner to remove members from the list. <br>
	 * This method calls https://api.twitter.com/1.1/lists/members/destroy.json
	 *
	 * @param listId     The id of the list.
	 * @param screenName The screen name of the member you wish to remove from the
	 *                   list.
	 * @return the updated list
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 ...
	 *
	 * @param listId      The id of the list.
	 * @param screenNames The screen names of the members you wish to remove from
	 *                    the list.
	 * @return the updated list
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/lists/members/destroy_all">POST
	 ...
	 *
	 * @param listId  The id of the list.
	 * @param userIds The array of ids of the user to add as member of the list. up
	 ...
	 *                        requested by a slug.
	 * @param slug            slug of the list
	 * @param screenNames     The screen names of the members you wish to remove
	 *                        from the list.
	 * @return the updated list
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 ...
	 *                        requested by a slug.
	 * @param slug            slug of the list
	 * @param userId          The screen name of the member you wish to remove from
	 *                        the list.
	 * @return the updated list
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 ...
	 *               returned to in the response body's next_cursor and
	 ...
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/lists/memberships">GET
	 ...
	 * This method calls https://api.twitter.com/1.1/lists/memberships.json
	 *
	 * @param count  The amount of results to return per page. No more than 1000
	 *               results will ever be returned in a single page.
	 * @param cursor Breaks the results into pages. Provide a value of -1 to begin
	 *               paging. Provide values as returned to in the response body's
	 *               next_cursor and previous_cursor attributes to page back and
	 *               forth in the list.
	 * @return the list of lists
	 * @throws TwitterException      when Twitter service or network is unavailable
	 * @throws IllegalStateException when authorization is not enabled
	 ...
	 *                     values as returned to in the response body's next_cursor
	 *                     and previous_cursor attributes to page back and forth in
	 *                     the list.
	 * @return the list of lists
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/lists/memberships">GET
	 ...
	 *
	 * @param listMemberId The id of the list member
	 * @param count        The amount of results to return per page. No more than
	 ...
	 * @param cursor               Breaks the results into pages. A single page
	 *                             contains 20 lists. Provide a value of -1 to begin
	 *                             paging. Provide values as returned to in the
	 *                             response body's next_cursor and previous_cursor
	 ...
	 *
	 * @param listMemberScreenName The screen name of the list member
	 * @param count                The amount of results to return per page. No more
	 *                             than 1000 results will ever be returned in a
	 *                             single page.
	 * @param cursor               Breaks the results into pages. A single page
	 *                             contains 20 lists. Provide a value of -1 to begin
	 *                             paging. Provide values as returned to in the
	 ...
	 *                             user owns, and the user represented by
	 *                             listMemberScreenName is a member of.
	 * @return the list of lists
	 * @throws TwitterException      when Twitter service or network is unavailable
	 ...
	 *                           attributes to page back and forth in the list.
	 * @param filterToOwnedLists Whether to return just lists the authenticating
	 *                           user owns, and the user represented by listMemberId
	 *                           is a member of.
	 * @return the list of lists
	 * @throws TwitterException      when Twitter service or network is unavailable
	 * @throws IllegalStateException when filerToOwnedLists is true but
	 ...
	 * @param listMemberId       The id of the list member
	 * @param count              The amount of results to return per page. No more
	 *                           than 1000 results will ever be returned in a single
	 *                           page.
	 * @param cursor             Breaks the results into pages. A single page
	 *                           contains 20 lists. Provide a value of -1 to begin
	 *                           paging. Provide values as returned to in the
	 ...
	 *                                    unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/lists/subscribers">GET
	 ...
	 *
	 * @param listId The id of the list
	 * @param count  Specifies the number of results to return per page. The default
	 *               is 20, with a maximum of 5,000.
	 * @param cursor Breaks the results into pages. A single page contains 20 lists.
	 *               Provide a value of -1 to begin paging. Provide values as
	 *               returned to in the response body's next_cursor and
	 *               previous_cursor attributes to page back and forth in the list.
	 ...
	 *
	 * @param listId     The id of the list
	 * @param count      Specifies the number of results to return per page. The
	 ...
	 *                   and previous_cursor attributes to page back and forth in
	 *                   the list.
	 * @param skipStatus When set to either true, t or 1 statuses will not be
	 ...
	 * @since Twitter4J 4.0.4
	 */
	PagableResponseList<User> getUserListSubscribers(long listId, int count, long cursor, boolean skipStatus)
			throws TwitterException;
	 ...
	 * @since Twitter4J 4.0.4
	 */
	PagableResponseList<User> getUserListSubscribers(long ownerId, String slug, int count, long cursor)
			throws TwitterException;
	 ...
	 * This method calls https://api.twitter.com/1.1/lists/subscribers.json
	 *
	 * @param ownerId    The user ID of the user who owns the list being requested
	 *                   by a slug.
	 * @param slug       slug of the list
	 * @param count      Specifies the number of results to return per page. The
	 *                   default is 20, with a maximum of 5,000.
	 ...
	 *                        requested by a slug.
	 * @param slug            slug of the list
	 * @param cursor          Breaks the results into pages. A single page contains
	 *                        20 lists. Provide a value of -1 to begin paging.
	 *                        Provide values as returned to in the response body's
	 *                        next_cursor and previous_cursor attributes to page
	 ...
	 *                        requested by a slug.
	 * @param slug            slug of the list
	 * @param count           Specifies the number of results to return per page.
	 ...
	 * @since Twitter4J 4.0.4
	 */
	PagableResponseList<User> getUserListSubscribers(String ownerScreenName, String slug, int count, long cursor)
			throws TwitterException;
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/lists/subscribers/create">POST
	 ...
	 *
	 * @param listId The id of the list.
	 * @param userId The id of the user who you want to know is a member or not of
	 *               the specified list.
	 * @return the updated list
	 * @throws TwitterException when Twitter service or network is unavailable , or
	 *                          the user is not a member of the specified
	 *                          list(TwitterException.getStatusCode() returns 404 in
	 *                          that case.)
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/lists/subscribers/show">GET
	 ...
	 *                        requested by a slug.
	 * @param slug            slug of the list
	 * @param userId          The id of the user who you want to know is a member or
	 *                        not of the specified list.
	 * @return the updated list
	 * @throws TwitterException when Twitter service or network is unavailable , or
	 *                          the user is not a member of the specified
	 *                          list(TwitterException.getStatusCode() returns 404 in
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/lists/subscribers/destroy">POST
	 ...
	 * able to add members to it. Lists are limited to having 5000 members, and you
	 * are limited to adding up to 100 members to a list at a time with this method.
	 * <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/lists/members/create_all">POST
	 ...
	 *                        requested by a slug.
	 * @param slug            slug of the list
	 * @param userIds         The array of ids of the user to add as member of the
	 *                        list. up to 100 are allowed in a single request.
	 * @return the list
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/lists/members/create_all">POST
	 ...
	 *
	 * @param listId      The id of the list.
	 * @param screenNames The array of screen names of the user to add as member of
	 *                    the list. up to 100 are allowed in a single request.
	 * @return the list
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/lists/members/create_all">POST
	 ...
	 *                        of the list. up to 100 are allowed in a single
	 *                        request.
	 * @return the list
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 ...
	 *                          that case.)
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/lists/members/show">GET
	 ...
	 * This method calls https://api.twitter.com/1.1/lists/members/show.json
	 *
	 * @param ownerScreenName Id The user ID of the user who owns the list being
	 *                        requested by a slug.
	 * @param slug            slug of the list
	 * @param userId          The id of the user who you want to know is a member or
	 *                        not of the specified list.
	...
	/**
	 * Adds a member to a list. The authenticated user must own the list to be able
	 * to add members to it. Lists are limited to having 5000 members. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/lists/members/create">POST
	 ...
	 *                       Values can be public or private. Lists are public by
	 ...
	 * This method calls https://api.twitter.com/1.1/lists/update.json
	 *
	 * @param ownerId        The user ID of the user who owns the list being
	 *                       requested by a slug.
	 * @param slug           slug of the list
	 * @param newListName    What you'd like to change the list's name to.
	 * @param isPublicList   Whether your list is public or private. Optional.
	 ...
	 * @since Twitter4J 3.0.2
	 */
	UserList updateUserList(String ownerScreenName, String slug, String newListName, boolean isPublicList,
	 ...
	 * @throws twitter4j.TwitterException when Twitter service or network is
	 *                                    unavailable, or the authenticated user
	 *                                    already has 20
	 *                                    lists(TwitterException.getStatusCode() ==
	 *                                    403).
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/lists/show">https://dev.twitter.com/docs/api/1.1/get/lists/show
	 ...
	 * @param cursor                   Breaks the results into pages. A single page
	 *                                 contains 20 lists. Provide a value of -1 to
	 *                                 begin paging. Provide values as returned to
	 *                                 in the response body's next_cursor and
	 *                                 previous_cursor attributes to page back and
	 *                                 forth in the list.
	 ...
	 *                                 Defaults to 20. No more than 1000 results
	 *                                 will ever be returned in a single page.
	 * @param cursor                   Breaks the results into pages. A single page
	 *                                 contains 20 lists. Provide a value of -1 to
	 *                                 begin paging. Provide values as returned to
	 *                                 in the response body's next_cursor and
	 ...
	 *
	 * @param listSubscriberId The ID of the list subscriber
	 * @param count            The amount of results to return per page. Defaults to
	 *                         20. No more than 1000 results will ever be returned
	 *                         in a single page.
	 * @param cursor           Breaks the results into pages. Provide a value of -1
	 *                         to begin paging. Provide values as returned to in the
	 *                         response body's next_cursor and previous_cursor
	 *                         attributes to page back and forth in the list.
	 * @return the list of lists the specified user is subscribed to
	 * @throws TwitterException when Twitter service or network is unavailable
	 ...
	 * only be shown if the authenticated user is also the owner of the lists. <br>
	 ...
	 * @param cursor              Breaks the results into pages. Provide a value of
	 *                            -1 to begin paging. Provide values as returned in
	 *                            the response body's next_cursor and
	 *                            previous_cursor attributes to page back and forth
	 *                            in the list. It is recommended to always use
	 *                            cursors when the method supports them. See
	 *                            <a href=
	 *                            "https://dev.twitter.com/docs/misc/cursoring">Using
	 *                            cursors</a> to navigate collections for more
	 *                            information.
	 ...
	 *
	 * @param listOwnerScreenName The screen name of the list owner
	 * @param count               The amount of results to return per page. Defaults
	 *                            to 20. No more than 1000 results will ever be
	 ...
	 *                    begin paging. Provide values as returned in the response
	 *                    body's next_cursor and previous_cursor attributes to page
	 *                    back and forth in the list. It is recommended to always
	 *                    use cursors when the method supports them. See <a href=
	 *                    "https://dev.twitter.com/docs/misc/cursoring">Using
	 *                    cursors</a> to navigate collections for more information.
	 * @return lists owned by the specified Twitter user
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @since Twitter4J 4.0.4
	 */
	 ...
	 *
	 * @param listOwnerId The id of the list owner
	 * @param count       The amount of results to return per page. Defaults to 20.
	 *                    No more than 1000 results will ever be returned in a
	 *                    single page.
	 * @param cursor      Breaks the results into pages. Provide a value of -1 to
	 *                    begin paging. Provide values as returned in the response
	 *                    body's next_cursor and previous_cursor attributes to page
