...
public interface FriendsFollowersResources {
	...
	/**
	 * Returns a collection of user IDs that the currently authenticated user does
	 * not want to receive retweets from. <br>
	 * This method calls
	 * https://api.twitter.com/1.1/friendships/no_retweets/ids.json
	 * 
	 * @return a collection of numeric IDs that the currently authenticated user
	 *         does not want to receive retweets from.
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/friendships/no_retweets/ids">GET
	 *      friendships/no_retweets/ids | Twitter Developers</a>
	 ...
	 *               guaranteed to be 5000 as suspended users are filterd out after
	 *               connections are queried. <br>
	 ...
	 *               maximum of 5,000 per distinct request. The value of count is
	 *               best thought of as a limit to the number of results to
	 *               return.<br>
	 *               When using the count parameter with this method, it is wise to
	 *               use a consistent count value across all requests to the same
	 *               user's collection.<br>
	 *               Usage of this parameter is encouraged in environments where all
	 ...
	 * This method calls https://api.twitter.com/1.1/friends/ids.json
	 *
	 * @param screenName Specifies the screen name of the user for whom to return
	 *                   the friends list.
	 ...
	 *                   out after connections are queried. <br>
	 *                   To begin paging provide a value of -1 as the cursor. The
	 *                   response from the API will include a previous_cursor and
	 *                   next_cursor to allow paging back and forth.
	 * @return an array of numeric IDs for every user the specified user is
	 ...
	 *                   next_cursor to allow paging back and forth.
	 * @param count      Specifies the number of IDs attempt retrieval of, up to a
	 *                   maximum of 5,000 per distinct request. The value of count
	 *                   is best thought of as a limit to the number of results to
	 *                   return.<br>
	 *                   When using the count parameter with this method, it is wise
	 *                   to use a consistent count value across all requests to the
	 *                   same user's collection.<br>
	 *                   Usage of this parameter is encouraged in environments where
	 *                   all 5,000 IDs constitutes too large of a response.
	 * @return an array of numeric IDs for every user the specified user is
	 *         following
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friends/ids">GET
	...
	/**
	 * Returns an array of numeric IDs for every user the specified user is followed
	 * by. <br>
	 ...
	 * This method calls https://api.twitter.com/1.1/followers/ids.json
	 *
	 * @param userId Specifies the ID of the user for whom to return the followers
	 *               list.
	 * @param cursor Causes the list of connections to be broken into pages of no
	 *               more than 5000 IDs at a time. The number of IDs returned is not
	 *               guaranteed to be 5000 as suspended users are filterd out after
	 ...
	 *               next_cursor to allow paging back and forth.
	 * @param count  Specifies the number of IDs attempt retrieval of, up to a
	 *               maximum of 5,000 per distinct request. <br>
	 *               The value of count is best thought of as a limit to the number
	 *               of results to return. <br>
	 *               When using the count parameter with this method, it is wise to
	 *               use a consistent count value across all requests to the same
	 *               user's collection. Usage of this parameter is encouraged in
	 *               environments where all 5,000 IDs constitutes too large of a
	 *               response.
	 * @return The ID or screen_name of the user to retrieve the friends ID list
	 *         for.
	 * @throws TwitterException when Twitter service or network is unavailable
	 ...
	 * @param count      Specifies the number of IDs attempt retrieval of, up to a
	 *                   maximum of 5,000 per distinct request. <br>
	 *                   The value of count is best thought of as a limit to the
	 *                   number of results to return. <br>
	 *                   When using the count parameter with this method, it is wise
	 *                   to use a consistent count value across all requests to the
	 *                   same user's collection. Usage of this parameter is
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "http://groups.google.com/group/twitter-api-announce/msg/34909da7c399169e">#newtwitter
	...
	/**
	 * Returns an array of numeric IDs for every user who has a pending request to
	 * follow the authenticating user. <br>
	 ...
	 * @return an array of numeric IDs for every user who has a pending request to
	 *         follow the authenticating user.
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/friendships/incoming">GET
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/friendships/outgoing">GET
	 ...
	 * already friends with the user an HTTP 403 will be returned. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/friendships/create">POST
	 ...
	 * a string describing the failure condition when unsuccessful. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/friendships/destroy">POST
	 ...
	 * This method calls https://api.twitter.com/1.1/friendships/destroy/[id].json
	 *
	 * @param screenName the screen name of the user for whom to request a list of
	 *                   friends
	 * @return User
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	...
	/**
	 * Allows you to enable or disable retweets and device notifications from the
	 * specified user. <br>
	 * This method has not been finalized and the interface is subject to change in
	 * incompatible ways. <br>
	 ...
	 * user is following (otherwise known as their "friends").<br>
	 ...
	 * <a href="https://dev.twitter.com/docs/misc/cursoring">Using cursors to
	 * navigate collections</a> for more information. <br>
	 ...
	 * @param cursor Causes the results to be broken into pages of no more than 20
	 *               records at a time.
	 * @return list of friends
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friends/list">GET
	 *      friends/list | Twitter Developers</a>
	 ...
	 * @param cursor     Causes the results to be broken into pages of no more than
	 ...
	 *
	 * @param userId              The ID of the user for whom to return results for.
	 * @param cursor              Causes the results to be broken into pages of no
	 *                            more than 20 records at a time.
	 * @param count               The number of users to return per page, up to a
	 *                            maximum of 200. Defaults to 20.
	 * @param skipStatus          When set to either true, statuses will not be
	 *                            included in the returned user objects.
	 * @param includeUserEntities The user object entities node will be disincluded
	 *                            when set to false.
	 * @return list of friends
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friends/list">GET
	 ...
	 * @since Twitter4J 4.0.2
	 */
	PagableResponseList<User> getFriendsList(long userId, long cursor, int count, boolean skipStatus,
	 ...
	 * This method calls https://api.twitter.com/1.1/friends/list.json
	 *
	 * @param screenName          The screen name of the user for whom to return
	 *                            results for.
	 * @param cursor              Causes the results to be broken into pages of no
	 *                            more than 20 records at a time.
	 * @param count               The number of users to return per page, up to a
	 ...
	 * @since Twitter4J 4.0.2
	 */
	PagableResponseList<User> getFriendsList(String screenName, long cursor, int count, boolean skipStatus,
			boolean includeUserEntities) throws TwitterException;
	 ...
	 * @since Twitter4J 4.0.2
	 */
	PagableResponseList<User> getFollowersList(long userId, long cursor, int count, boolean skipStatus,
			boolean includeUserEntities) throws TwitterException;
	 ...
	 * @since Twitter4J 4.0.2
	 */
	PagableResponseList<User> getFollowersList(String screenName, long cursor, int count, boolean skipStatus,
			boolean includeUserEntities) throws TwitterException;
}