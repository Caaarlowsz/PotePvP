...
public interface TrendsResources {
	 ...
	 * on <a href="http://search.twitter.com/">Twitter Search</a>, and the Twitter
	 * Search URL.<br>
	 ...
	 *
	 * @param woeid <a href="http://developer.yahoo.com/geo/geoplanet/">The Yahoo!
	 *              Where On Earth ID</a> of the location to return trending
	 ...
	 * response is an array of &quot;locations&quot; that encode the location's
	 * WOEID (a <a href="http://developer.yahoo.com/geo/geoplanet/">Yahoo! Where On
	 * Earth ID</a>) and some other human-readable information such as a canonical
	 ...
	 * @throws twitter4j.TwitterException when Twitter service or network is
	 *                                    unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/trends/available">GET
	 ...
	 * the location belongs in.<br>
	 * A WOEID is a <a href="http://developer.yahoo.com/geo/geoplanet/">Yahoo! Where
	 * On Earth ID</a>. <br>
	 * This method calls https://api.twitter.com/1.1/trends/closest.json
	 *
	 * @param location the available trend locations will be sorted by distance to
	 *                 the lat and long passed in. The sort is nearest to furthest.
	 * @return the locations
	 * @throws twitter4j.TwitterException when Twitter service or network is
	 *                                    unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/trends/closest">GET
