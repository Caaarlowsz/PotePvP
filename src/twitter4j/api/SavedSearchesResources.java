...
public interface SavedSearchesResources {
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/saved_searches/show/:id">GET
	 ...
	 * This method calls
	 * https://api.twitter.com/1.1/saved_searches/saved_searches/create.json
	 *
	 * @param query the query string
	 * @return the data for a created saved search
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/saved_searches/create">POST
	 ...
	 * id must be owned by the authenticating user. <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/saved_searches/destroy/:id">POST
