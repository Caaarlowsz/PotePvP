...
public interface HelpResources {
	 ...
	 * which are not usernames, maximum photo resolutions, and t.co URL lengths.<br>
	 ...
	 *                                    unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/help/configuration">GET
	 ...
	 * @throws twitter4j.TwitterException when Twitter service or network is
	 *                                    unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/help/tos">GET help/tos
	 ...
	 * family from the first component of the path after the resource version.<br>
	 ...
	 * a map of all rate limited GET methods. If your application only uses a few of
	 * methods, please explicitly provide a resources parameter with the specified
	 * resource families you work with.<br>
	 ...
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/application/rate_limit_status">GET
