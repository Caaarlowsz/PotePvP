...
public interface TimelinesResources {
	 ...
	 * users's @screen_name) for the authenticating user.<br>
	 * The timeline returned is the equivalent of the one seen when you view your
	 * mentions on twitter.com.<br>
	 * This method can only return up to 800 tweets.<br>
	 * See <a href="https://dev.twitter.com/docs/working-with-timelines">Working
	 ...
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/statuses/mentions">GET
	 ...
	 * This method calls https://api.twitter.com/1.1/statuses/mentions_timeline
	 *
	 * @param paging controls pagination. Supports since_id, max_id, zcount
	 *               parameters.
	 * @return the 20 most recent replies
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/statuses/mentions">GET
	 ...
	 * statuses/friends_timeline, except that home_timeline also contains retweets,
	 * while statuses/friends_timeline does not for backwards compatibility reasons.
	 * In a future version of the API, statuses/friends_timeline will be deprected
	 * and replaced by home_timeline. <br>
	 * This method calls https://api.twitter.com/1.1/statuses/home_timeline
	 *
	 * @return list of the home Timeline
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/statuses/home_timeline">GET
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/get/statuses/retweets_of_me">GET
