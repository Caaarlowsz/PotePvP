...
public interface FavoritesResources {
	 ...
	 * user specified by the ID parameter in the requested format. <br>
	 * This method calls https://api.twitter.com/1.1/favorites.json
	 *
	 * @return favorite statuses
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/favorites">GET
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/favorites/create/:id">POST
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href=
	 *      "https://dev.twitter.com/docs/api/1.1/post/favorites/destroy/:id">POST
