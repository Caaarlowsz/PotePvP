...
public abstract class HttpResponse {
	 ...
	 * @throws TwitterException when there is any network issue upon response body
	 *                          consumption
	 */
	...
	public String toString() {
		return "HttpResponse{" + "statusCode=" + statusCode + ", responseAsString='" + responseAsString + '\'' + ", is="
				+ is + ", streamConsumed=" + streamConsumed + '}';
	}
}