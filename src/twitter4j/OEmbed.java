...
public interface OEmbed extends TwitterResponse, java.io.Serializable {
	 ...
	 * XSS vulnerabilities. The markup should be valid XHTML 1.0 Basic.
	 * 
...
//    String getProviderURL();
	 ...
	 * The source URL of the image. Consumers should be able to insert this URL into
	 * an &lt;img&gt; element. Only HTTP and HTTPS URLs are valid.
	 * 
...
//    String getType();
	 ...
	 * 
	 * @return The suggested cache lifetime for this resource, in seconds. Consumers
