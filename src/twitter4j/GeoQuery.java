...
public final class GeoQuery implements java.io.Serializable {
	...
	/**
	 * Sets a hint on the "region" in which to search. If a number, then this is a
	...
	/**
	 * Sets a hint as to the number of results to return. This does not guarantee
	 * that the number of results returned will equal max_results, but instead
	 * informs how many "nearby" results to return. Ideally, only pass in the number
	 * of places you intend to display to the user here.
	 *
	...
	public String toString() {
		return "GeoQuery{" + "location=" + location + ", query='" + query + '\'' + ", ip='" + ip + '\'' + ", accuracy='"
				+ accuracy + '\'' + ", granularity='" + granularity + '\'' + ", maxResults=" + maxResults + '}';
	}
}
