...
public final class StatusUpdate implements java.io.Serializable {
	...
	public boolean equals(Object o) {
		...
		if (mediaName != null ? !mediaName.equals(that.mediaName) : that.mediaName != null)
			return false;
		if (mediaIds != null ? !Arrays.equals(mediaIds, that.mediaIds) : that.mediaIds != null)
			return false;
	...
	public String toString() {
		return "StatusUpdate{" + "status='" + status + '\'' + ", inReplyToStatusId=" + inReplyToStatusId + ", location="
				+ location + ", placeId='" + placeId + '\'' + ", displayCoordinates=" + displayCoordinates
				+ ", possiblySensitive=" + possiblySensitive + ", mediaName='" + mediaName + '\'' + ", mediaBody="
				+ mediaBody + ", mediaFile=" + mediaFile + ", mediaIds=" + mediaIds + '}';
	}
}
