...
public interface RateLimitStatus extends java.io.Serializable {
	 ...
	 * This value is identical to the &quot;X-Rate-Limit-Remaining&quot; response
	 * header.
	 *
	 ...
	 * This value is identical to the &quot;X-Rate-Limit-Limit&quot; response
	 * header.
	 *
	 ...
	 * ends.<br>
	 * This is a value provided/calculated only by Twitter4J for handiness and not a
	 * part of the twitter API spec.
	 *
