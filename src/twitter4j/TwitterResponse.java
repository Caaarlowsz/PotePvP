...
public interface TwitterResponse extends java.io.Serializable {
	 ...
	 * @see <a href=
	 *      "https://dev.twitter.com/pages/application-permission-model-faq#how-do-we-know-what-the-access-level-of-a-user-token-is">Application
	 *      Permission Model FAQ - How do we know what the access level of a user
	 *      token is?</a>
