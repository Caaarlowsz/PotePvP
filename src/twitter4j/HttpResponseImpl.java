...
public class HttpResponseImpl extends HttpResponse {
	...
	HttpResponseImpl(HttpURLConnection con, HttpClientConfiguration conf) throws IOException {
		...
		try {
			...
			/*
			 * If the user has revoked the access token in use, then Twitter naughtily
			 * returns a 401 with no "WWW-Authenticate" header.
			 *
			 * This causes an IOException in the getResponseCode() method call. See
			 * https://dev.twitter.com/issues/1114 This call can, however, me made a second
