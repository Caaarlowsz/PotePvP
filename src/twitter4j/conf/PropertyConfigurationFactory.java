...
class PropertyConfigurationFactory implements ConfigurationFactory {
	...
	static {
		...
		// calling ROOT_CONFIGURATION.dumpConfiguration() will cause
		// ExceptionInInitializerError as Logger has not been initialized.
		// as a quick and dirty solution, static initializer of twitter4j.Logger will
		// call dumpConfiguration() on behalf.
	}
