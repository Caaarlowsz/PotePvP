...
public abstract class CommandClass {
	...
	public Group getPosteriorGroup(CommandSender sender, int value) {
		if (sender instanceof Player) {
			...
			return Group.values()[player.getServerGroup().ordinal() + value] == null && player.getServerGroup().ordinal() + value > Group.ADMIN.ordinal() ? Group.ADMIN : Group.values()[player.getServerGroup().ordinal() + value];
		} else {
			return Group.ADMIN;
		}
	}
