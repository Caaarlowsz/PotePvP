...
public class VanishMode {
	...
	public void setAdmin(Player p) {
		...
		player.sendMessage("�fVoc� entrou no modo �4�lADMIN�f.");
		player.sendMessage("Voc� est� invisivel para todos os jogadores�f.");
	...
	public void setPlayer(Player p) {
		...
		player.updateVanished();
		player.sendMessage("�fVoc� entrou no modo �a�lJOGADOR�f.");
		player.sendMessage("Voc� est� visivel para todos os jogadores�f.");
