...
public class WarpManager extends Config {
	...
	public WarpManager() {
		...
		if (getConfig().contains("ss.World")) {
			this.screenshare = new Warp("Screenshare", new Location(Bukkit.getWorld(getConfig().getString("ss.World")),
					getConfig().getDouble("ss.X"), getConfig().getDouble("ss.Y"), getConfig().getDouble("ss.Z")),
					Material.DIAMOND, 9999);
		} else {
			this.screenshare = new Warp("Screenshare", new Location(Bukkit.getWorld("world"), 0, 120, 0),
					Material.DIAMOND, 9999);
		}
		...
		if (getConfig().contains("1v1.Spawn")) {
			Location spawnLocation = new Location(Bukkit.getWorld(getConfig().getString("1v1.Spawn.World")),
					getConfig().getDouble("1v1.Spawn.X"), getConfig().getDouble("1v1.Spawn.Y"),
					getConfig().getDouble("1v1.Spawn.Z"));
			...
			Location firstLocation = new Location(Bukkit.getWorld(getConfig().getString("1v1.Posicao1.World")),
					getConfig().getDouble("1v1.Posicao1.X"), getConfig().getDouble("1v1.Posicao1.Y"),
					getConfig().getDouble("1v1.Posicao1.Z"));
			...
			Location secondLocation = new Location(Bukkit.getWorld(getConfig().getString("1v1.Posicao2.World")),
					getConfig().getDouble("1v1.Posicao2.X"), getConfig().getDouble("1v1.Posicao2.Y"),
					getConfig().getDouble("1v1.Posicao2.Z"));
		...
		if (getConfig().contains("Sumo.Spawn")) {
			Location spawnLocation = new Location(Bukkit.getWorld(getConfig().getString("Sumo.Spawn.World")),
					getConfig().getDouble("Sumo.Spawn.X"), getConfig().getDouble("Sumo.Spawn.Y"),
					getConfig().getDouble("Sumo.Spawn.Z"));
			...
			Location firstLocation = new Location(Bukkit.getWorld(getConfig().getString("Sumo.Posicao1.World")),
					getConfig().getDouble("Sumo.Posicao1.X"), getConfig().getDouble("Sumo.Posicao1.Y"),
					getConfig().getDouble("Sumo.Posicao1.Z"));
			...
			Location secondLocation = new Location(Bukkit.getWorld(getConfig().getString("Sumo.Posicao2.World")),
					getConfig().getDouble("Sumo.Posicao2.X"), getConfig().getDouble("Sumo.Posicao2.Y"),
					getConfig().getDouble("Sumo.Posicao2.Z"));
			...
			this.warps.put("sumo",
					new WarpSumo("Sumo", spawnLocation, Material.BLAZE_ROD, firstLocation, secondLocation));
		}
	}
	...
	public void addWarp(String warpName) {
		if (getConfig().contains("warps." + warpName.toLowerCase() + ".World")) {
			Location warpLocation = new Location(
					Bukkit.getWorld(getConfig().getString("warps." + warpName.toLowerCase() + ".World")),
					getConfig().getDouble("warps." + warpName.toLowerCase() + ".X"),
					getConfig().getDouble("warps." + warpName.toLowerCase() + ".Y"),
					getConfig().getDouble("warps." + warpName.toLowerCase() + ".Z"));
			...
			addWarp(warpName, warpLocation, getConfig().getInt("warps." + warpName.toLowerCase() + ".Item"),
					protection);
		} else {
	...
	public class WarpSumo extends Warp {
		...
		public WarpSumo(String warpName, Location warpLocation, Material warpIcon, Location firstLocation,
	...
	public class Warp1v1 extends Warp {
		...
		public Warp1v1(String warpName, Location warpLocation, Material warpIcon, Location firstLocation,
				Location secondLocation) {
			super(warpName, warpLocation, warpIcon, 99.9);
			this.warpLocation = new WarpLocation(firstLocation, secondLocation);
		}
