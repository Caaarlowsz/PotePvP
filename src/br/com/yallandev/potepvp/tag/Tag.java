...
public enum Tag {
	...
	DEVELOPER("�3�lDEVELOPER �3", Group.DONO), DONO("�4�lDONO �4", Group.DONO), ADMIN("�c�lADMIN �c", Group.ADMIN),
	GERENTE("�c�lGERENTE �c", Group.GERENTE), MODPLUS("�5�lMOD+ �5", Group.MODPLUS), MODGC("�5�lMODGC �5", Group.MODGC),
	MOD("�5�lMOD �5", Group.MOD), TRIAL("�d�lTRIAL �d", Group.TRIAL),
	YOUTUBERPLUS("�3�lYT+ �3", Group.YOUTUBERPLUS, true), HELPER("�9�lHELPER �9", Group.HELPER),
	BUILDER("�e�lBUILDER �e", Group.BUILDER), YOUTUBER("�b�lYT �b", Group.YOUTUBER, true),
	HEIGHT("�2�lHEIGHT �2", Group.HEIGHT), BETA("�1�lBETA �1", Group.BETA), PRO("�6�lPRO �6", Group.PRO),
	MVP("�9�lMVP �9", Group.MVP), TOP1("�2�lTOP1 �2", null), LOSER("�8�lLOSER �8", null),
	LIGHT("�a�lLIGHT �a", Group.LIGHT), MEMBRO("�f", Group.MEMBRO);
