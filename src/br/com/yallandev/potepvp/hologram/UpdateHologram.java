	...
	public List<String> getTop(String type, int max) {
		...
		try {
			...
			while (rs.next()) {
				...
				if (i <= 3) {
					tops.add("§a" + i + " §8- §f" + getColor(player) + player.getUserName() + " §8|§a " + rs.getInt(type));
				} else if (i <= 5) {
					tops.add("§e" + i + " §8- §f" + getColor(player)+ player.getUserName() + " §8|§a " + rs.getInt(type));
				} else if (i <= 7) {
					tops.add("§c" + i + " §8- §f" + getColor(player)+ player.getUserName() + " §8|§a " + rs.getInt(type));
				} else {
					tops.add("§4" + i + " §8- §f" + getColor(player)+ player.getUserName() + " §8|§a " + rs.getInt(type));
				}
			}
