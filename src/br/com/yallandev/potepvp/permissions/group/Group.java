...
public enum Group {
	...
	YOUTUBERPLUS(new YoutuberGroup()), TRIAL(new ModerationGroup()),
	MOD(new ModerationGroup()), MODGC(new ModerationGroup()),
	MODPLUS(new ModerationGroup()), GERENTE(new AdminGroup()), 
	ADMIN(new AdminGroup()), DONO(new OwnerGroup()), 
