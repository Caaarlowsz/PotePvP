...
public class Avatar extends Kit {
	...
	public Avatar() {
		super("Avatar", Material.BEACON, 18000, Arrays.asList(new ItemManager(Material.BEACON, "�aAvatar").build()),
				Arrays.asList("�fUse seu avatar para", "�fpara controlar todos os",
						"�felementos ar, terra, agua e fogo."));
	}
