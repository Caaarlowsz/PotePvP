...
public class Deshfire extends Kit {
	...
	public Deshfire() {
		super("Deshfire", Material.REDSTONE_BLOCK, 18000, true, Arrays.asList("Use seu deshfire para", "dar um desh no ar e", "deixar todas as pessoas", "ao seu redor pegando", "fogo."));
	}
	...
	public void onDeshfireClick(PlayerInteractEvent event) {
		...
		if (hasKit(p)) {
			...
			sendAction(p, "Você usou seu §4§lDESHFIRE§f.");
