...
public class Pote extends Kit {
	...
	public Pote() {
		super("Pote", Material.BOWL, 16000, true, Arrays.asList("Use seu pote para", "ter uma chance de 40%", "para tirar todos os", "do seu inimigo, mas caso", "não retire os potes,", "ficará com efeitos negativos."));
	}
	...
	public void onPlayerInteract(PlayerInteractEntityEvent e) {
		...
		if (pro <= 40) {
			...
			sendAction(p, "Você §alimpou§f o os potes do jogador §a" + t.getName());
			sendMessage(p, "");
		} else {
			sendMessage(p, "Você recebeu os efeitos ");
		}
 	}
