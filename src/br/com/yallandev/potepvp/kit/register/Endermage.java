...
public class Endermage extends Kit {
	...
	public Endermage() {
		super("Endermage", Material.PORTAL, 14000, true,
				Arrays.asList("Use seu endermage para", "puxar os jogadores at�", "voc�!"));
	}
	...
	public void onKitEndermage(Location portal, Player p1, Player p2) {
		...
		p2.sendMessage("�aVoc� foi puxado por um Endermage");
		p1.sendMessage("�cVoc� puxou players com o endermage");
