...
public class Switcher extends Kit {
	...
	public Switcher() {
		super("Switcher", Material.SNOW_BALL, 18000,
				Arrays.asList(new ItemManager(Material.SNOW_BALL, "�aSwitcher").build()), Arrays.asList(
						"�fUse seu avatar para", "�fpara controlar todos os", "�felementos ar, terra, agua e fogo."));
	}
