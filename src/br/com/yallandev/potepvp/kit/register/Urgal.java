...
public class Urgal extends Kit {
	...
	public Urgal() {
		super("Urgal", new ItemManager(Material.POTION, "§aUrgal").setDurability(8201).setLore(Arrays.asList("Use seu endermage para", "puxar os jogadores até", "você!")).build(), Arrays.asList(new ItemManager(Material.COAL_BLOCK, "§aUrgal").build()), 14000);
	}
	...
	public void onPlayerInteract(PlayerInteractEvent e) {
		...
		player.sendMessage("Você recebeu força por §a10 segundos§f.");
	}
