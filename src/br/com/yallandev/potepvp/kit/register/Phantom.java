...
public class Phantom extends Kit {
	...
	public Phantom() {
		super("Phantom", Material.FEATHER, 18000, Arrays.asList(new ItemManager(Material.FEATHER, "§aPhantom").build()), Arrays.asList("§fUse seu phantom para", "§fpara poder voar pelo", "§fcéu por 5 segundos."));
	}
