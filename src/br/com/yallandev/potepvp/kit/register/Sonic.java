...
public class Sonic extends Kit {
	...
	public Sonic() {
		super("Sonic", Material.LAPIS_BLOCK, 18000, true, Arrays.asList("Use seu sonic para", "dar um desh no ar", "e deixar todos os seus", "inimigos proximos com", "veneno."));
	}
	...
	public void onDeshfireClick(PlayerInteractEvent event) {
		...
		if (hasKit(p)) {
			...
			sendAction(p, "Você usou seu §b§lSONIC§f.");
